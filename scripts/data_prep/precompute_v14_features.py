"""width-38 biophysics + FEGS for the v14 pool (v5 + matched pairs), FASTA order. Mirrors
precompute_v11_features. is_yeast generated by cluster_groups_v14. CPU multiprocessing; FEGS ~10ms/seq.

  /opt/homebrew/Caskroom/mambaforge/base/envs/rnaphaseek/bin/python scripts/data_prep/precompute_v14_features.py
"""
import os, sys, time
...
def main():
    ...
    POS = ROOT / "Data/raw/multispecies/strict_pool_v14_positives.fasta"
    NEG = ROOT / "Data/raw/multispecies/strict_pool_v14_negatives_all.fasta"
    print("== biophysics (width 38) ==")
    biophys_for(POS, SP / "biophys_v14_pos.npy")
    biophys_for(NEG, SP / "biophys_v14_neg.npy")
    print("== FEGS ==")
    for fa, d in [("strict_pool_v14_positives.fasta", "fegs_v14_pos"),
                  ("strict_pool_v14_negatives_all.fasta", "fegs_v14_neg")]:
        t = time.time()
    ...
    print("DONE precompute_v14_features", flush=True)
