"""v13 pool — PURELY ADDITIVE: v5/v6 production pool + the de-leaked matched TRAINING pairs
(scripts/data_prep/generate_matched_pairs_v13.py). Teaches the structure-specificity discrimination
that the corpus lacked (G-tracts must be FREE). The held-out Williams benchmark (v11_additions) is
NOT included — it stays a clean test. Writes strict_pool_v13_{positives,negatives_all}.fasta.

  /opt/homebrew/Caskroom/mambaforge/base/envs/rnaphaseek/bin/python scripts/data_prep/build_v13_pool.py
"""
import os, sys
...
ADD = "Data/raw/multispecies/staging/v13_matched_pairs.fasta"
POS_OUT = "Data/raw/multispecies/strict_pool_v13_positives.fasta"
NEG_OUT = "Data/raw/multispecies/strict_pool_v13_negatives_all.fasta"
...
def main():
    ...
    print("=== v13 pool build (v5 + de-leaked matched training pairs) ===")
